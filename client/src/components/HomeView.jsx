  ...
  return (
    <div className="flex-1 flex flex-col items-center justify-center px-4 py-8 sm:py-12 relative overflow-hidden">
      ...
      <div className="max-w-4xl w-full text-center space-y-6 sm:space-y-8 relative z-10">
        {/* Badge */}
        <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-slate-900/90 border border-slate-800 text-[11px] sm:text-xs text-cyan-400 shadow-xl">
        ...
        <div className="grid md:grid-cols-2 gap-5 sm:gap-6 max-w-3xl mx-auto pt-2 text-left">
          {/* Create Room Card */}
          <div className="glass-panel p-6 sm:p-8 rounded-2xl border border-slate-800/80 flex flex-col justify-between hover:border-cyan-500/30 transition-all shadow-2xl relative overflow-hidden group">
            ...
            <div className="pt-6 relative z-10">
              <button
                ...
                className="w-full py-3.5 px-6 rounded-xl font-semibold bg-gradient-to-r from-cyan-500 to-blue-600 hover:from-cyan-400 hover:to-blue-500 text-slate-950 shadow-lg shadow-cyan-500/25 flex items-center justify-center gap-2 transition-all disabled:opacity-50 active:scale-[0.98] text-sm"
              >
          ...
          <div className="glass-panel p-6 sm:p-8 rounded-2xl border border-slate-800/80 flex flex-col justify-between hover:border-purple-500/30 transition-all shadow-2xl relative overflow-hidden group">
            ...
            <div className="space-y-3 sm:space-y-4 relative z-10">
              ...
              <div>
                ...
                <p className="text-xs sm:text-sm text-slate-400 mt-1">
                  Enter 6-digit room code or scan QR code with camera.
                </p>
              </div>
            </div>
            ...
            <form onSubmit={handleJoin} className="pt-4 space-y-3 relative z-10">
              <div className="relative flex items-center gap-2">
                <div className="relative flex-1">
                  <input
                    ...
                    className="w-full py-3 px-3.5 rounded-xl glass-input tracking-widest text-center font-mono font-bold text-base sm:text-lg uppercase placeholder:tracking-normal placeholder:font-sans placeholder:text-slate-600 placeholder:text-xs"
                  />
                  <button
                    type="button"
                    onClick={handlePaste}
                ...
                <button
                  ...
                  className="py-3 px-3.5 rounded-xl bg-purple-500/10 hover:bg-purple-500/20 text-purple-400 border border-purple-500/20 flex items-center justify-center shrink-0 transition-colors"
              ...
              <button
                ...
                className="w-full py-3.5 px-6 rounded-xl font-semibold bg-slate-800 hover:bg-slate-700 text-slate-100 border border-slate-700 hover:border-slate-600 flex items-center justify-center gap-2 transition-all disabled:opacity-50 active:scale-[0.98] text-sm"
              >
                {isJoining ? (
        ...
        <div className="grid sm:grid-cols-3 gap-3.5 max-w-3xl mx-auto pt-4 sm:pt-6">
          <div className="p-3.5 rounded-xl bg-slate-900/60 border border-slate-800/60 text-left flex items-start gap-3">
            <div className="p-2 rounded-lg bg-emerald-500/10 text-emerald-400 shrink-0">
              <Lock className="w-4 h-4" />
            </div>
            <div>
              <h4 className="text-xs font-semibold text-slate-200">100% Direct P2P</h4>
              <p className="text-[11px] text-slate-400 mt-0.5">Files pass directly peer-to-peer. Zero server storage.</p>
            </div>
          </div>
          ...
          <div className="p-3.5 rounded-xl bg-slate-900/60 border border-slate-800/60 text-left flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-[11px] text-slate-400 mt-0.5">Speed limited only by local network or bandwidth.</p>
            </div>
          </div>
          ...
          <div className="p-3.5 rounded-xl bg-slate-900/60 border border-slate-800/60 text-left flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-[11px] text-slate-400 mt-0.5">Works on Windows, Mac, Linux, Android, iOS browsers.</p>
            </div>
          </div>
        </div>
      </div>
