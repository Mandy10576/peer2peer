    ...
    <nav className="w-full border-b border-slate-800/80 bg-slate-950/80 backdrop-blur-md sticky top-0 z-40 px-3 sm:px-6 py-2.5">
      <div className="max-w-7xl mx-auto flex items-center justify-between gap-2 overflow-x-hidden">
        ...
        <div className="flex items-center gap-2 shrink-0">
          <div className="w-8 h-8 sm:w-9 sm:h-9 rounded-lg bg-gradient-to-tr from-lime-500 to-orange-600 p-0.5 shadow-md shadow-lime-500/20">
            <div className="w-full h-full bg-slate-950 rounded-[7px] flex items-center justify-center">
              <Zap className="w-4 h-4 text-lime-400 fill-lime-400/20" />
            </div>
          </div>
          <div className="flex items-center gap-1.5">
            <span className="font-extrabold text-base sm:text-lg tracking-tight bg-gradient-to-r from-lime-400 via-lime-300 to-orange-400 bg-clip-text text-transparent">
              AeroDrop
            </span>
            <span className="hidden sm:inline-block text-[10px] font-semibold uppercase px-1.5 py-0.5 rounded bg-lime-500/10 text-lime-400 border border-lime-500/20">
              P2P
            </span>
          </div>
        </div>
        ...
        <div className="flex items-center gap-1.5 sm:gap-2 shrink-0">
          ...
          >
            {soundEnabled ? <Volume2 className="w-3.5 h-3.5 text-lime-400" /> : <VolumeX className="w-3.5 h-3.5 text-slate-500" />}
          </button>
              ...
              {isEditingName ? (
                <div className="flex items-center gap-1">
                  <input
                    ...
                    className="bg-slate-950 border border-lime-500/40 rounded px-1.5 py-0.5 text-[11px] text-slate-100 focus:outline-none w-20"
                    autoFocus
                  />
